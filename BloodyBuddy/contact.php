...
<head>
  ...
  <title>Blood Buddy - connect the donors</title>
...
<body id="top">
  ...
  <header class="header">
      ...
      <div class="container">
        <ul class="contact-list">
          ...
          <li class="contact-item">
            ...
            <a href="" class="contact-link">+91-1111-222-333</a>
          </li>
        </ul>
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        <a href="#" class="logo">Blood Buddy</a>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="section-subtitle">Blood Buddy</p>
            <h1 class="h1 hero-title">Contact Us</h1>
            <h2 style="color: var(--royal-blue-light);">Address</h2>
            <p class="hero-text">
            ADITYA BIRLA MEMORIAL HOSPITAL,<br>
            ADITYA BIRLA MARG, CHINCHWAD, PUNE - 411033, MAHARASHTRA , INDIA.
            </p>
            <h2 style="color: var(--royal-blue-light);">Contact Details</h2>
            <p class="hero-text">
            MOBILE: +91 1111 222 333 | TELEPHONE: 0484-292674<br>
          ...
          <figure class="hero-banner">
            <iframe src="https://maps.app.goo.gl/fhDEkvBDXxhVXHV76" width="700" height="600" style="border:1;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </figure>
        </div>
    </section>
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="https://maps.app.goo.gl/fhDEkvBDXxhVXHV76">
            <address class="item-text">
            Aditya Birla Hospital, <br>
          ...
          <li class="footer-item">
            ...
            <a href="" class="footer-link">+91-1111-222-333</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; All 2024 Rights Reserved by Samiksha Jadhav
          
  <h5 class="credit">Designed with ❤</i> by <a href="https://www.linkedin.com/in/samiksha-jadhav-123591220/"> Samiksha Jadhav</a></h5>
        </p>
        <ul class="social-list">
          <li>
            <a href="" class="social-link">
