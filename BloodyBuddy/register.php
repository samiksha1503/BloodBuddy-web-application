...
<body id="top">
      ...
      <div class="container">
        <ul class="contact-list">
          ...
          <li class="contact-item">
            ...
            <a href="+91-1111-222-333" class="contact-link">+91-1111-222-333</a>
          </li>
        </ul>
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="+91-1111-222-333" class="footer-link">+91-1111-222-333</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          &copy; 2024 All Rights Reserved by Samiksha Jadhav
